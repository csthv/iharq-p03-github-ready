...
# Current manifest
mp=(ROOT/"CURRENT_CUMULATIVE_REPOSITORY_MANIFEST.json") if (ROOT/"CURRENT_CUMULATIVE_REPOSITORY_MANIFEST.json").exists() else (ROOT/"CURRENT_GITHUB_READY_REPOSITORY_MANIFEST.json")
