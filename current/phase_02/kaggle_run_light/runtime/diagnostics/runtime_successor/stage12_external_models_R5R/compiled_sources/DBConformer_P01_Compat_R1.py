...
import math
from torch.nn.init import trunc_normal_  # IHARQ R5 runtime-compatibility substitution; initialization API only
...
class Stem(nn.Module):
    ...
    def forward(self, x):
        ...
        # IHARQ R5 P01 compatibility: canonical 480-sample windows contain no extra endpoint.
        # No dataset-specific endpoint deletion is applied. P01 itself remains byte-unchanged.
