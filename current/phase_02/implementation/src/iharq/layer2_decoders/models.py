...
class BraindecodeAdapter(Adapter):
    ...
    def _model_class(self):
        ...
        mapping={'EEGNet':'EEGNet','EEGConformer':'EEGConformer','EEGTCNet':'EEGTCNet'}
    ...
    def _build(self):
        ...
        kw={'n_chans':self.n_chans,'n_outputs':2,'n_times':self.input_samples,'drop_prob':self.dropout}
        # Braindecode EEGNet uses drop_prob; preserve the legacy
        # dropout alias only for other neural variants.
        if self.variant!='EEGNet': kw['dropout']=self.dropout
